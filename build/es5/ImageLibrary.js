...
(function (nid) {
    ...
    (function (display) {
        var BitmapData = (function () {
            ...
            BitmapData.prototype.setPixel32 = function (x, y, value) {
                var pos = (x + y * this.width) * 4;
                var r = value >> 24;
                var g = value >> 16 & 0xFF;
                var b = value >> 8 & 0xFF;
    ...
    (function (encoder) {
        ...
        var JPEGEncoder = (function () {
            ...
            function JPEGEncoder(quality) {
                if (quality === void 0) { quality = 50.0; }
                this.DENSITY_UNIT = 1;
                this.xDENSITY = 1;
                this.yDENSITY = 1;
                //--------------------------------------------------------------------------
            ...
            Object.defineProperty(JPEGEncoder.prototype, "contentType", {
                //--------------------------------------------------------------------------
                //
                //  Properties
                //
             ...
             *  @productversion Flex 3
             */
            JPEGEncoder.prototype.encode = function (bitmapData, dpi) {
                if (dpi === void 0) { dpi = 0; }
             ...
             *  @productversion Flex 3
             */
            JPEGEncoder.prototype.encodeByteArray = function (byteArray, width, height, transparent, dpi) {
             ...
             */
            JPEGEncoder.prototype.initHuffmanTbl = function () {
             ...
             *  @private
             */
            JPEGEncoder.prototype.computeHuffmanTbl = function (nrcodes, std_table) {
                var codevalue = 0;
                var pos_in_table = 0;
                var HT = [];
                for (var k = 1; k <= 16; k++) {
             ...
             */
            JPEGEncoder.prototype.initCategoryNumber = function () {
                var nr;
                var nrlower = 1;
                var nrupper = 2;
             ...
             */
            JPEGEncoder.prototype.initQuantTables = function (sf) {
                var i = 0;
                var t;
                var YQT = [
             ...
             *  @private
             */
            JPEGEncoder.prototype.internalEncode = function (source, width, height, transparent, dpi) {
                if (transparent === void 0) { transparent = true; }
                if (dpi === void 0) { dpi = 0; }
             ...
             *  @private
             */
            JPEGEncoder.prototype.RGB2YUV = function (sourceBitmapData, sourceByteArray, xpos, ypos, width, height) {
             ...
             *  @private
             */
            JPEGEncoder.prototype.processDU = function (CDU, fdtbl, DC, HTDC, HTAC) {
                var EOB = HTAC[0x00];
             ...
             *  @private
             */
            JPEGEncoder.prototype.fDCTQuant = function (data, fdtbl) {
                // Pass 1: process rows.
                var dataOff = 0;
                var i;
                for (i = 0; i < 8; i++) {
             ...
             *  @private
             */
            JPEGEncoder.prototype.writeBits = function (bs) {
                var value = bs.val;
                var posval = bs.len - 1;
                while (posval >= 0) {
                    if (value & (1 << posval)) {
             ...
             *  @private
             */
            JPEGEncoder.prototype.writeByte = function (value) {
                this.byteout.writeByte(value);
            };
            /**
             *  @private
             */
            JPEGEncoder.prototype.writeWord = function (value) {
             ...
             *  @private
             */
            JPEGEncoder.prototype.writeAPP0 = function (dpi) {
             ...
             *  @private
             */
            JPEGEncoder.prototype.writeDQT = function () {
             ...
             *  @private
             */
            JPEGEncoder.prototype.writeSOF0 = function (width, height) {
             ...
             *  @private
             */
            JPEGEncoder.prototype.writeDHT = function () {
                var i;
             ...
             *  @private
             */
            JPEGEncoder.prototype.writeSOS = function () {
...
var BitString = (function () {
     ...
     *  @productversion Flex 3
     */
    BitString.prototype.BitString = function () {
    };
    return BitString;
})();
var nid;
(function (nid) {
    ...
    (function (encoder) {
        ...
        var PNGEncoder = (function () {
            ...
            Object.defineProperty(PNGEncoder, "contentType", {
                get: function () {
            ...
            PNGEncoder.encode = function (bitmapData, dpi) {
                if (dpi === void 0) { dpi = 0; }
            ...
            PNGEncoder.encodeByteArray = function (byteArray, width, height, transparent, dpi) {
                if (transparent === void 0) { transparent = true; }
                if (dpi === void 0) { dpi = 0; }
                this.initializeCRCTable();
                return this.internalEncode(byteArray, width, height, transparent, dpi);
            };
            PNGEncoder.initializeCRCTable = function () {
            ...
            PNGEncoder.internalEncode = function (source, width, height, transparent, dpi) {
                // The source is either a BitmapData or a ByteArray.
                var sourceBitmapData = source;
                var sourceByteArray = source;
                if (sourceByteArray)
...
(function (nid) {
    ...
    var ImageLibrary = (function () {
        ...
        ImageLibrary.encodePNG = function (bitmap, callback) {
            if (callback === void 0) { callback = null; }
        ...
        ImageLibrary.encodeJPEG = function (bitmap, callback) {
            if (callback === void 0) { callback = null; }
            if (bitmap instanceof ImageData) {
